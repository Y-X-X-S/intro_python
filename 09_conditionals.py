...
# Elif es una abreviación "else if", nos permite seguir evaluando expresiones. Podemos tener tantos como necesitemos

if Yaritza_age > Gaby_age:
    print("Yaritza es mayor que gaby")
elif Yaritza_age < Gaby_age:
    print("Yaritza es menor que gaby")
else:
    print("Tienen la misma edad Gaby y Yaritza")